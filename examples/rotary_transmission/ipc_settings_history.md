...
| 031 | 1.25 | 1.00 ms | 1e7 | BDPCG | Completed 200/200 steps with zero hardening. Versus 0.5 ms: gear angles agreed within 0.1%, speeds within about 1-2%, peak strain within 4%, and escape within 0.3%; accepted as the faster pre-lock baseline. |
